...
// RunHost takes an IP as argument and listens for incoming messages on that IP address.
...
// RunGuest takes destination IP address as argument and connects to that IP.
